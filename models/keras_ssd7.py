...
# BM 2/20/25    
        return tensor - np.array(subtract_mean) # np.array makes an array with all elements set at the value 'subtract_mean'
        #mean = np.mean(tensor)
        #return tensor - np.array(mean) # np.array makes an array with all elements set at the value 'subtract_mean'

    def input_stddev_normalization(tensor):
#        stddev = np.dstd()
#        return tensor / np.array(stddev)
